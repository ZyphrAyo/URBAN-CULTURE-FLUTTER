    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 2*fem, 1.4*fem),
            child: Row(
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1.1*fem, 0*fem, 1.1*fem, 2.2*fem),
            child: Align(
          ...
          Container(
            margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 1*fem, 2.5*fem),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
          ...
          Container(
            margin: EdgeInsets.fromLTRB(0.6*fem, 0*fem, 0*fem, 2.5*fem),
            child: Align(
