            ...
            child: Container(
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 1*fem, 9.3*fem),
                      child: Container(
                        decoration: BoxDecoration(
                          color: Color(0xFFFFFFFF),
                        ),
                        child: Container(
                          padding: EdgeInsets.fromLTRB(1*fem, 1.5*fem, 1*fem, 1.9*fem),
                          child: Stack(
                            clipBehavior: Clip.none,
                            children: [
                              SizedBox(
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Expanded(
                                                                  child: Container(
                                                                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1.7*fem, 0*fem),
                                                                    child: Container(
                                                                      decoration: BoxDecoration(
                                                                        color: Color(0xFF020202),
                                                                      ),
